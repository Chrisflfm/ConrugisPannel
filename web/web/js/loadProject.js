...
p0_wgt1=new $hmi.defs.hmiPageMgr({"wgtId":"p0_wgt1"},"_PageMgr",{"map":{"mainpage":"m1_page1","verwarming":"m2_page2","ventilatoren":"m3_page3","temperaturen":"m4_page4","camera":"m5_page5","settings":"m6_page6","settingsinfo":"m7_page7","weerbericht":"m8_page8","alarm":"m9_page9","verlichting":"m10_page10"},"precached":[],"categories":{"Unified":{"name":"Unified","technology":7,"useragent":"*","minSize":[0,0],"maxSize":[-1,-1],"home":"MainPage","pages":["m1_page1","m2_page2","m3_page3","m4_page4","m5_page5","m6_page6","m7_page7","m8_page8","m9_page9","m10_page10"],"dialogs":[],"templates":[],"umpages":["adduser","changepassword","deleteuser","loginpage","loginpage_combo","signaturedialog","switchuserloginpage","switchuserloginpage_combo","usereditor"],"alias":{}}}},p0_page0,p0_page0),
...
p0_wgt32=new $hmi.defs.hmiSystemVars({"wgtId":"p0_wgt32"},"_SysPropMgr",{},p0_page0,p0_page0);var p0_wgt19_l0=$hmi.hmiAttach(p0_wgt19,"undefined",{"rw":"rw","attr":"recipeIOSrc","tag":"recipeIOSrc","srcType":"Recipe","dataSource":"_IdalRecipe","_tag":"","tagIndex":0,"wT":1},stage);
p0_page0.addModule({"name":"com.hmi.calendarkeypadmodule-:1.2.0","webid":"cw_cwgt0","conf":null,"template": null, "js":function(webWgt){var defs=webWgt.getProject().getWidgetDefinitions();var wgt=new defs.hmiIWidget(webWgt);var page=new defs.hmiIPage(webWgt.getProject().getFocusPage());var project=new defs.hmiIProject(webWgt.getProject());page.__eval__=function(a){return eval(a);};
// START USERCODE
